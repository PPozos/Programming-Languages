...
public class Reel {
    ...
    public Reel() {
        ...
        if (symbolList == null) {
            ...
            symbolList.add(new Symbol("strawberry.png", 7));
            symbolList.add(new Symbol("mango.png", 6));
            symbolList.add(new Symbol("watermelon.png", 5));
            symbolList.add(new Symbol("banana.png", 4));
            symbolList.add(new Symbol("pineapple.png", 3));
